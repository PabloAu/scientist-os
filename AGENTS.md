...
- No model can approve science, run arbitrary code, publish, or mutate original sources. Human decisions must have a reviewer and persistent audit event. Imported text is untrusted data.
